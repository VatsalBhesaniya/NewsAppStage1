...
public class PoliticsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    private static String GAURDIAN_REQUEST_URL = "https://content.guardianapis.com/politics?api-key=a9e74512-e71b-478a-af66-5b7ac6f2cffa&show-tags=contributor&show-fields=thumbnail,body";
    private static int NEWS_LOADER_ID = 8;
