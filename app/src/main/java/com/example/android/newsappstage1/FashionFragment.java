...
public class FashionFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    public static final String LOG_TAG = FashionFragment.class.getName();
    private static final String GAURDIAN_REQUEST_URL = "https://content.guardianapis.com/fashion?api-key=a9e74512-e71b-478a-af66-5b7ac6f2cffa&show-tags=contributor&show-fields=thumbnail,body";
